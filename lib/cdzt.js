(function (global, factory) {
  ...
  (global = global || self, factory(global.cdzt = {}));
  ...
  var sliceData = function sliceData() {
    ...
    var findStart = function findStart(data) {
      return parseInt(multiply(length(data), start));
    };

    var findEnd = function findEnd(data) {
      return parseInt(multiply(length(data), end));
    };
    ...
    var newDatasets = map(function (_ref) {
  ...
  var setWidth = function setWidth(chartInstance) {
    return function (x) {
      chartInstance._cdzt.dragDiv.style.top = "".concat(chartInstance._cdzt.canvasRect.top, "px");
      chartInstance._cdzt.dragDiv.style.height = "".concat(chartInstance._cdzt.canvasRect.height, "px");
  ...
  var cdzt = {
    ...
    beforeInit: function beforeInit(chartInstance) {
      ...
      chartInstance._cdzt.originalData = clone(chartInstance.data); // The level of which to ignore the click and drag

      chartInstance._cdzt.zoomTolerance = pathOr(ZOOM_TOLERANCE, ['options', 'cdzt', 'zoomTolerance'], chartInstance);
    ...
    afterRender: function afterRender(chartInstance) {
      ...
      var mouseDownHandler = function mouseDownHandler(e) {
        ...
        if (!chartInstance._cdzt.isZooming) {
          ...
          chartInstance._cdzt.clamp = clamp(chartInstance.chartArea.left, rect.right);
      ...
      var mouseMoveHandler = function mouseMoveHandler(e) {
        ...
        if (chartInstance._cdzt.isZooming) {
          var width = reduce(subtract, chartInstance._cdzt.clamp(e.x), [chartInstance._cdzt.canvasRect.x, chartInstance._cdzt.dragStart]);
